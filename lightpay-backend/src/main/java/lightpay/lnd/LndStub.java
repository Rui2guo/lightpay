...
import lightpay.lnd.grpc.LightningGrpc.LightningStub;

@Component
public class LndStub {
    ...
    private void init() throws DecoderException, IOException {
        ...
        stub = LightningGrpc.newStub(channel);
    }
    ...
    public LightningStub getInstance() {
        return stub;
    }
